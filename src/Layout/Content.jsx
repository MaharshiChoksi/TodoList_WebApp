    ...
    return (
        <div className="flex-grow text-2xl min-w-full p-10 pb-20 align-center justify-center">
            <div className="flex flex-wrap gap-5 justify-center">
                ...
                <button className="border-2 rounded-lg text-lg max-lg:text-sm" onClick={() => { const returned = validateAndAdd(((inputVal.current.value).toString()).trim()); returned === false ? setAlert(true) : (setTask([...tasks, returned]), setAlert(false)); inputVal.current.value = '' }}>Add Task</button>
