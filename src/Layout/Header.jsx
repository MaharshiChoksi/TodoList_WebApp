...
const Menu = ({ ChangeState }) => {
    return (
        <div className='absolute flex min-w-full min-h-screen z-10 backdrop-blur-sm items-center justify-center top-0'>
            <div className='flex flex-col gap-5 p-[10%] items-center relative border-2 border-gray-400 rounded-xl font-mono max-sm:text-3xl text-4xl md:text-6xl backdrop-blur-sm bg-violet-900/30'>
