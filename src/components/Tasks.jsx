...
const EditBar = ({ props, ChgData, setShowHiddenDiv }) => {
    ...
    return (<div className='fixed flex min-w-full min-h-[100%] z-10 backdrop-blur-sm items-center justify-center top-0'>
        <div className='flex flex-col gap-5 m-[10%] p-[5%] items-center relative border-2 border-gray-400 rounded-xl font-mono max-sm:text-xl text-4xl max-md:text-3xl bg-neutral-900/95'>
            ...
            <textarea type="text" name="task" defaultValue={props.data} placeholder="Edit your task" className=" rounded-xl bg-black border-2 text-white p-2 text-xl max-sm:w-30 max-lg:h-30 max-lg:text-lg" ref={data} />
