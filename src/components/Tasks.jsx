...
export const Task = ({ props, onDelete, toggleStatus, ChgData }) => {
    ...
    return (<>        <div className={`task flex flex-col items-center p-4 mt-5 gap-5 max-lg:gap-5 max-md:text-sm max-w-3xl border-2 ${borderColor} rounded-xl text-center whitespace-pre-wrap`}>
